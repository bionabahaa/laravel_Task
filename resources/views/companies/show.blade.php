			...
			<div class="body">
				<form class="form-horizontal">
					<div class="form-group">
						<label for="name" class="col-md-4 control-label">{{ $company->first_name }}</label>
						<div class="col-md-6">
							<div class="form-line">
					...
					<div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
						...
						<div class="col-md-6">
							<div class="card" style="width: 18rem;">
								<img class="card-img-top img-responsive" src="{{asset('storage/logo/'.$company['logo'])}}"  width="100px" height="200px"alt="">
								<div class="card-body">
								</div>
							</div>
						</div>
