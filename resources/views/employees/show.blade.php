               ...
               <div class="body">
                   <form class="form-horizontal">
                       <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                           <label for="name" class="col-md-4 control-label">Employee First Name</label>
                           <div class="col-md-6">
								<div class="form-line">
                       ...
                       <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
						<label for="name" class="col-md-4 control-label">Employee Last Name</label>
						<div class="col-md-6">
							<div class="form-line">
                       ...
                       <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                           <label for="email" class="col-md-4 control-label">Employee Email</label>
                           <div class="col-md-6">
								<div class="form-line">
					...
					<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
						<label for="phone" class="col-md-4 control-label">Employee Phone</label>
						<div class="col-md-6">
							<div class="form-line">
					 ...
					 <div class="form-group{{ $errors->has('company_id') ? ' has-error' : '' }}">
						<label for="company_id" class="col-md-4 control-label">Employee Company</label>
						<div class="col-md-6">
							<div class="form-line">
